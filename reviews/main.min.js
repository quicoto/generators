(()=>{(()=>{let o={};function h(t){let{type:e,showFormatted:c,season:r,episode:i,volume:d,date:n,rating:s,comment:u,share:m}=t;function p(){let a="";return+r&&(a+=`season: ${+r}`),+i&&(a+=`
episode: ${+i}`),+d&&(a+=`volume: ${+d}`),a}function l(){let a=c;return e!=="manga"&&(a+=` ${r}x${i}`),a}return`
---
